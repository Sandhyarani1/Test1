...
public class TestBannerAlerts extends AccuWeatherBaseTest
{
	...
	public void RW_T182()
	{
		...
		softAssert.assertEquals(bannerAlerts.getAlertsSummary().replaceAll("\\s+", ""),
				alertsSummary.get(0).replaceAll("\\s+", ""),
		...
		softAssert.assertEquals(bannerAlerts.getAlertHeaderSummary().replaceAll("\\s+", ""),
				alertsSummary.get(0).replaceAll("\\s+", ""),
	...
	public void RW_T183()
	{
		...
		softAssert.assertEquals(BannerAlerts.alertsSummary.get(0).replaceAll("\\s+", ""),
				alertsSummary.get(0).replaceAll("\\s+", ""),
				"Issue-----> Alert Summary not matching for the first alert for city--->" + cityHavingAlerts
						+ " and zipcode---->" + zipCodeHavingAlerts);
		softAssert.assertEquals(BannerAlerts.alertsSummary.get(1).replaceAll("\\s+", ""),
				alertsSummary.get(1).replaceAll("\\s+", ""),
				"Issue-----> Alert Summary not matching for the second alert for city--->" + cityHavingAlerts
						+ " and zipcode---->" + zipCodeHavingAlerts);
