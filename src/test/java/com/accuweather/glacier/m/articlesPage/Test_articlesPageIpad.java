...
import com.accuweather.glacier.m.pages.ArticlesPageIpad;
import com.chameleon.utils.Sleeper;

public class Test_articlesPageIpad  extends AccuWeatherMobileBaseTest
{
	...
	ArticlesPageIpad articles= new ArticlesPageIpad();
	...
	public void RW_TC945_Navigation_to_News_Article_Page_succesfully()
	{
		...
		articles.isWeatherNewsSubMenuDisplayed();
		articles.navigateToNewsPage();
		Sleeper.sleep(5);
		waitUntilElementIsDisplayedOrClickable();
		waitUntilWindowExistsWithTitle(newPageTitle);
		String actuallandingpageURL=getDriver().getCurrentUrl();
		Assert.assertEquals(actuallandingpageURL, expectedNewsPageUrl);
	}
