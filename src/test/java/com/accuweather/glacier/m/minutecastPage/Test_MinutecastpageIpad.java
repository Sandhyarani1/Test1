...
import com.accuweather.glacier.m.pages.MinutecastpageIpad;
import com.chameleon.utils.Sleeper;

public class Test_MinutecastpageIpad extends AccuWeatherMobileBaseTest
{
	String citySearchedByName="Chicago";

	//String MINUTECAST_PAGE_TITLE="https://qualityassurance.accuweather.com/en/us/chicago/60608/weather-forecast/348308";
	...
	private static final String MINUTECAST_PAGE_TITLE="Chicago, IL MinuteCast(R) Weather | AccuWeather";
	...
	public void TC_RW_T831_navigateToMinutecastForecastPage() 
	{
		...
		Sleeper.sleep(4);
		waitUntilWindowExistsWithTitle(MINUTECAST_PAGE_TITLE);
	...
	public void TC_RW_T832_navigateToMinutecastForecastPage_validateMinutecasttabHighlighted() 
	{
		testStart("Navigation to Minutecast  forecast page ");
		minutecast.searchCityByName(citySearchedByName);    
		minutecast.selectCityByName();
		waitUntilElementIsDisplayedOrClickable();
		Sleeper.sleep(3);
		...
		Sleeper.sleep(4);
		waitUntilWindowExistsWithTitle(MINUTECAST_PAGE_TITLE);
		Assert.assertEquals(minutecast.minutecastTabHighlighted(), EXPECTED_MINUTECASTTAB_COLOR);
	}
	...
	public void RW_TC833_validatingMinutecastRadarMapTooltipcloseswhenclickedTwice() 
	{
		...
		minutecast.isNavigationtoMinutecastpage();
		Sleeper.sleep(4);
		waitUntilWindowExistsWithTitle(MINUTECAST_PAGE_TITLE);	minutecast.scrolldownpage();
		Sleeper.sleep(3);
		minutecast.clickonTooltip();
		Sleeper.sleep(3);
		minutecast.clickonTooltip();
	...
	public void RW_TC88_Navigating_toMinutecastpage_validating_LegendRain_displayedwithText_LightandSevere() 
	{
