...
import com.accuweather.glacier.m.pages.nationalRadarIpad;
import com.accuweather.glacier.www.AccuWeatherBaseTest;
import com.chameleon.utils.Sleeper;

public class Test_NationalRadarPageIpad extends AccuWeatherBaseTest {
	...
	private nationalRadarIpad radarPage = new nationalRadarIpad();
	...
	public void RW_TC170c_Validate_Fullscreen_Radarmap_closed_when_clicked_onCloseSymbol() {
		testStart(
				"Navigate to National Radar page Click on Full screen button and Validate full screen exits when clicked on close symbol");
		radarPage.searchCityByName(citySearchedByName);
		radarPage.selectCityByName();
		waitUntilElementIsDisplayedOrClickable();
		Sleeper.sleep(3);
