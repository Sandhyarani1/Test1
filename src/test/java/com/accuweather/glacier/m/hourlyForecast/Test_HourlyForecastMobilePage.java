...
public class Test_HourlyForecastMobilePage extends AccuWeatherMobileBaseTest {
	...
	private String FirstDayURL = "https://qualityassurance.accuweather.com/en/us/royal-oak/48073/hourly-weather-forecast/20813_pc?day=1";
	...
	/*
	 * @Test(priority = 27) public void TC11_getStationCode_And_GTMOffset() throws
	 * ParseException, IOException { final RestResponse qaResponse =
	 * AccuweatherRest.locations().v1(QA).searchByLocationKey("23238_pc", true);
	 * System.out.println(qaResponse.getResponse());
	 * System.out.println(qaResponse.getStatusCode()); //JSONObject myResponse = new
	 * JSONObject(response.toString());
	 * 
	 * 
	 * 
	 * String url =
	 * "http://accuweather-api-glacier-northcentral-us.cloudapp.net/locations/v1/348181?apikey=5251445912b143d8b4bee5a741762dd1&language=en-us&details=True";
	 * URL obj = new URL(url); HttpURLConnection con = (HttpURLConnection)
	 * obj.openConnection(); // optional default is GET con.setRequestMethod("GET");
	 * //add request header con.setRequestProperty("User-Agent", "Mozilla/5.0"); int
	 ...
	 * 
	 * in.close(); //print in String System.out.println(response.toString()); //Read
	 * JSON response and print JSONObject myResponse = new
	 * JSONObject(response.toString()); JSONObject region =
	 * myResponse.getJSONObject("Region"); String ID = region.getString("ID");
	 * System.out.println("ID: "+ID); System.out.println(region.length());
	 * JSONObject geoPosition = myResponse.getJSONObject("GeoPosition");
	 * System.out.println("Value: "+geoPosition.getJSONObject("Elevation").
	 * getJSONObject("Metric").getDouble("Value")); //JSONArray getArray =
