...
public class Test_LandingPage extends AccuWeatherMobileBaseTest {
	...
	public void TC1_VerifyDefaultLocationNameAndAkamaiNameAreNotSame() {
		...
		landingpage.isRecentLocationDisplayed();
		actualLocationName = landingpage.getDefaultLocationName();
	...
	public void TC1_VerifyDefaultLocationAndCrumbNamesAreSame() {
		...
		landingpage.isRecentLocationDisplayed();
		actualLocationName = landingpage.getDefaultLocationName();
		crumbLocationName = landingpage.getCrumbLocationName();
	...
	public void TC3_VerifyRecentThreeLocationsAreDisplayed() {
		...
		landingpage.isRecentLocationDisplayed();
		landingpage.isSecondLocationDisplayed();
		landingpage.isThirdLocationDisplayed();
		expectedLocationSize = 3;
		actualLocationSize = landingpage.getAllLocationsSize();
		Assert.assertEquals(actualLocationSize, expectedLocationSize);
	}
	...
	public void TC9_IsVideoAutoPlayedOnHomePage() throws InterruptedException {
		...
		waitUntilElementIsDisplayedOrClickable();
		actualJWPlayerStatus = landingpage.getVideoClassAttribute();
	...
	public void TC10_IsStickyVideoAutoPlayedOnHomePage() throws InterruptedException {
		...
		WebPageLoaded.isDomInteractive(5000);
		waitUntilElementIsDisplayedOrClickable();
		actualJWPlayerStatus = landingpage.getStickyVideoClassAttribute();
		Assert.assertEquals(actualJWPlayerStatus, expectedJWPlayerStatus);
	...
	public void TC12_IsWeatherRadarDisplayedFromMoreMapsLink() {
		...
		WebPageLoaded.isDomInteractive(1000);
		waitUntilElementIsDisplayedOrClickable();
		actualWeatherRadarTitle = getDriver().getTitle();
		Assert.assertEquals(actualWeatherRadarTitle, expectedWeatherRadarTitle);
	}
}