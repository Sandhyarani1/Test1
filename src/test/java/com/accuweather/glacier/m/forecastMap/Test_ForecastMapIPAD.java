...
import com.accuweather.glacier.m.pages.ForeCastWeatherIPAD;
...
public class Test_ForecastMapIPAD extends AccuWeatherBaseTest {
	...
	private ForeCastWeatherIPAD foreCastWeatherPage = new ForeCastWeatherIPAD();
	...
	public void RW_T1380_WeatherForecastMapsPage_verifyWeatherForecastMapsPageLoads() {
		...
		foreCastWeatherPage.mouseHoverOnRadarAndMaps();
		foreCastWeatherPage.isForecastMapsSubMenuDisplayed();
		foreCastWeatherPage.navigateToForeCastPage();
		String actualForecastURL = getDriver().getCurrentUrl();
		Assert.assertEquals(actualForecastURL, EXPECTED_FORECAST_PAGE_URL);
	}

	@Test(priority = 2, enabled = true)
	public void RW_T1380_ForecastTabHighlightedOnForecasrPage_verifyForecastTabIsHighlighted() {
