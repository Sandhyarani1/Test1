...
public class NavigationBar extends BasePage {
	private By byLogo = By.cssSelector("body > div > div.component-sticky-container.header > div > div.main-menu > div.logo-wrapper > div > a > img");
	...
	private By bySettingCountry = By.cssSelector(
			"div.settings-wrap > div.dropdown-select.fade-in-left > div.dropdown-select-wrapper > div.select-title");
	private By bySettingLanguage = By.cssSelector("div.settings-wrap > div.fade-in-left:nth-of-type(2) > div > div");
	private By bySettingTemperature = By
			.cssSelector("div.settings-wrap > div.temp-switcher.fade-in-left > span.temp-switcher-label");
	private By bySettingCountryUpArrow = By
			.cssSelector("div > div:nth-child(1) > div.dropdown-select-wrapper > svg.hide-mobile.icon-chevron");
	private By bySettingMyRecentCountries = By
			.cssSelector("div > div.dropdown-select.fade-in-left > div.dropdown-content > div.dropdown-content-title");
	...
	private By bySettingLanguageArrow = By
			.cssSelector("div > div.fade-in-left:nth-of-type(2) > div > svg.hide-mobile.icon-chevron");
	private By bySettingLangugaeList = By.cssSelector("div > div > div.dropdown-content");
	private By bySettingLanguageSelect = By.cssSelector(
			"div > div.dropdown-select.locale-dropdown.fade-in-left > div.dropdown-content > div.dropdown-content-item:nth-child(3)");
	private By bySettingFarTempLabel = By
			.cssSelector("div > div.temp-switcher.fade-in-left > div.switcher-container > span.switcher-label");
	private By bySettingCentigradeLabel = By
			.cssSelector("div.settings-wrap > div.temp-switcher.fade-in-left > div.switcher-container.switch-right");
	private By bySettingTempBall = By
			.cssSelector("div > div.temp-switcher.fade-in-left > div.switcher-container > div.switcher > div.ball");
	private By bySettingTempBar = By
			.cssSelector("div > div.temp-switcher.fade-in-left > div.switcher-container > div.switcher > div.bar");
	...
	private By bySuperSearch2 = By.xpath("//a[contains(text(),'Stockholm, Stockholm, SE')]");
	private By byBrowseLocation = By.cssSelector("div.mega-menu-search > div.content-column > a.super-search-browse");
	private By byBrowseLocation2 = By.xpath("//a[contains(text(),'Browse for your location')]");
	private By byTopNavCTA = By
			.cssSelector("div.mega-menu-search > div.content-column > div.super-search-current-location");
	...
	private By byTopNavChicagoCityImage = By.cssSelector(
			"div.mega-menu-search > div.content-column > div.popular-location.fade-in-left:nth-of-type(2) > img");
	private By byTopNavDCCityImage = By.cssSelector(
			"div.mega-menu-search > div.content-column > div.popular-location.fade-in-left:nth-of-type(3) > img");
	private By byTopNavHoustonCityImage = By.cssSelector(
			"div.mega-menu-search > div.content-column > div.popular-location.fade-in-left:nth-of-type(4) > img");
	private By byFirstCityName = By.cssSelector(
			"div > div > a.recent-location-item-header.recent-location-link.fade-in-left > span.recent-location-name");
	...
	private By byWatchNewsSubMenu = By
			.cssSelector("div.mega-menu-content > div.mega-menu-item.mega-menu-item-cta.fade-in-left > a.button-cta");
	...
	private By byNewsSubMenu = By
			.cssSelector("div.mega-menu-item.mega-menu-item-cta.fade-in-left > a:nth-child(1) > h4");
	...
	private By bySeverWeatherSubMenu = By
			.cssSelector("div.mega-menu > div > div.mega-menu-item.mega-menu-item-cta.fade-in-left > a > h4");
	...
	private By byVideoDescription = By
			.cssSelector("div.mega-menu-content > div.mega-menu-item.mega-menu-item-cta.fade-in-left > p");
	...
	private By byTrendingNowDescription = By.cssSelector(
			"div.mega-menu-content > div.mega-menu-item.mega-menu-item-link.fade-in-left:nth-of-type(2) > p");
	...
	private By byStormChasersDescription = By.cssSelector(
			"div.mega-menu-content > div.mega-menu-item.mega-menu-item-link.fade-in-left:nth-of-type(4) > p");
	...
	private By byVideoDescriptionLink = By
			.cssSelector("div.menu-dropdown > div > div:nth-child(4) > div > a > p.thumb-description");
	...
	private By byAWProfessionalSubMenu = By.cssSelector(
			"div > div.mega-menu-content > div.mega-menu-item.mega-menu-item-link.fade-in-left:nth-of-type(4) > a > h4");
	...
	private By byFacebookIcon = By.cssSelector(
			"div.mega-menu-content > div.header-social.fade-in-left:nth-of-type(7) > a > svg.icon-facebook > g > path");
	private By byTwitterIcon = By.cssSelector(
			"div.mega-menu-content > div.header-social.fade-in-left:nth-of-type(7) > a > svg.icon-twitter > g > path");
	private By byYoutubeIcon = By.cssSelector(
			"div.mega-menu-content > div.header-social.fade-in-left:nth-of-type(7) > a > svg.icon-youtube > g > path");
	private By byInstagramIcon = By.cssSelector(
			"div.mega-menu-content > div.header-social.fade-in-left:nth-of-type(7) > a >img.icon-instagram");
	...
	public void clickBrowseYourLocationLink2() {
		WebPageLoaded.isDomInteractive();
		WebTextbox browselocation = getDriver().findTextbox(byBrowseLocation2);
		browselocation.click();
		Sleeper.sleep(3);
	}
	...
	public void locationSearch2Chars() {
		...
		Sleeper.sleep(3);
		getDriver().executeJavaScript("seetest:client.sendText('{ENTER}')");
	}
	
	public void locationSearch2Chars2() {
		WebElement element = getDriver().findElement(bySuperSearch);
		getDriver().executeJavaScript("arguments[0].setAttribute('value', 'st')", element);
		Sleeper.sleep(3);
		getDriver().executeJavaScript("seetest:client.sendText('{Done}')");
	}
	
	public void locationSearch2Chars3() {
		WebElement element = getDriver().findElement(bySuperSearch);
	...
	public void enterlocationSearch2() throws AWTException, InterruptedException {
		getDriver().findElement(bySuperSearch2).click();
