...
public class NewsWeatherPageIOS extends MobileBasePage {
	...
	private By byNews = By.xpath("//h1[contains(text(),'News')]");
	private By byVideos = By.xpath("//span[contains(text(),'Videos')]");
	private By byBlogs = By.xpath("//span[contains(text(),'BLOGS')]");
	private By byPersonalities = By.xpath("//span[contains(text(),'Personalities')]");
	...
	public Boolean clickBreadCrumbMenuNews() {
		WebPageLoaded.isDomInteractive();
		getDriver().findElement(byBreadCrumbMenuNews).scrollIntoView();
	...
	public Boolean clickbyBreadCrumbMenuWeatherNews() {
		WebPageLoaded.isDomInteractive();
		getDriver().findElement(byBreadCrumbMenuWeatherNews).jsClick();
		return true;
	}
	...
	public Boolean locateRightRailOrganism() {
		WebPageLoaded.isDomInteractive();
		return  getDriver().findElements(byLightrail).size()>0;
	}
