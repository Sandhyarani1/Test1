...
import com.chameleon.selenium.web.WebPageLoaded;
	...
	public class ForeCastWeatherIPAD extends MobileBasePage {
		...
		private By byIceLegendBarColor = By.cssSelector("div.page-column-1 > div:nth-child(1) > div.map-container.full-mobile-width.content-module > div.map-tools > div.forecast-map-legend > div:nth-child(4) > div.color-bar.ice > span");
		...
		public Boolean verifyPresenceOfSliderBarWithPlayButtonAndTime()
		{
			WebPageLoaded.isDomInteractive();
			Sleeper.sleep(1);
			getDriver().executeJavaScript("window.scrollTo(0, 50)");
			Sleeper.sleep(1);
		...
		public String verifyIceLegendBarColor()
		{
			...
			String result = (String) DriverManager.getWebDriver().executeJavaScript(
					"return getComputedStyle(document.querySelector(\"body > div > div:nth-child(5) > div > div.page-column-1 > div:nth-child(1) > div.map-container.full-mobile-width.content-module > div.map-tools > div.forecast-map-legend > div:nth-child(4) > div.color-bar.ice > span\")).backgroundColor;",
					ele);
			String arrowcolourdisplayed = Color.fromString(result).asHex();
			return arrowcolourdisplayed;
		}
		...
		public String verifyToolTipClosed() {
			...
			String BoarderColor = (String) DriverManager.getWebDriver().executeJavaScript(
					"return getComputedStyle(document.querySelector(\"body > div > div:nth-child(5) > div > div.page-column-1 > div:nth-child(1) > div.map-container.full-mobile-width.content-module > div.map-header > div > div.tooltip-overlay > div.tooltip-header > div\")).backgroundColor;",
					newsTab);
		...
		/**
		 * Method to click I understand buttton on home page
		 * 
		 * @author MOHAMMED
		 */
