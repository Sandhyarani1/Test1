...
public class WebPageLoaded {
    ...
    @Deprecated
    public static boolean isElementLoaded(Class clazz, ExtendedWebDriver oDriver, WebElement obj) {
    ...
    @SuppressWarnings("rawtypes")
    @Deprecated
    public static boolean isElementLoaded(Class clazz, ExtendedWebDriver oDriver, WebElement obj, int timeout) {
    ...
    public static boolean isDomInteractive() {
        ExtendedDriver driver = DriverManager.getDriver();
    ...
    public static boolean isDomComplete() {
        ExtendedDriver driver = DriverManager.getDriver();
        return isDomComplete(driver.getPageTimeout());
    }
